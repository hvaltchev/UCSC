...
class Store:
    ...
    def __init__(self, name):
        ...
        print(f"Store number {self.__number_of_stores} created.")
        self.name = name
...
class PersonnelDept:
    ...
    def Hire(self, name):
        ...
        print(self.store_name, (
              f"welcomes {new_guy}, our new welcomer."))
        return new_guy
...
def main():
    ...
    jane.Greet()
    print(jane, f"here's ${jane.CalculatePay(2):.2f} for you. ")
