...
"special method", __str__, which is called whenever:
   1.  f"{printable_stack_object}"
   2.  "{}".format(printable_stack_object)
   3.  str(printable_stack_object)
   4.  print(printable_stack_object) """
    
import sys, os
sys.path.insert(0, os.path.join(os.path.split(__file__)[0], ".."))
import Lab17_OOP.lab17_1 as stack_def  # copy of lab exercise
