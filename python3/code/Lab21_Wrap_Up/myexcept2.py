...
class NonPositiveNumber(ArithmeticError):
    ...
    def __init__(self, *args):
        """We call to the base class initializer
    ...
    def __str__(self):
        return f"You messed {NonPositiveNumber.times} {'time' if NonPositiveNumber.times==1 else 'times'}! {self.args}"
...
def main():
    for trial in range(5):
        ...
        except NonPositiveNumber as exception_obj:
