...
def SeparateThousands(number, decimal_digits=None):
    ...
    if decimal_digits == None:
        ...
        formatted = f"{number:.{decimal_digits}f}"
    ...
    for number in (100, 100.1545, 12345.5452, 1200, 1200.23,
        ...
        for sign in (1, -1):
            for digits in (None, 0, 1, 2, 8):
                value = sign * number
                print(f"SeparateThousands({value}, {digits}) --> '{ SeparateThousands(value, digits)}'")
...
SeparateThousands(-100.1545, 0) --> '-100'
[30 lines deleted]
SeparateThousands(-1200.23, 1) --> '-1,200.2'
SeparateThousands(-1200.23, 2) --> '-1,200.23'
SeparateThousands(-1200.23, 8) --> '-1,200.23000000'
